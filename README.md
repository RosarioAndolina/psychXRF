...
## Train
```console
psychxrf [-h] --h5data H5DATA [--batch-size BATCH_SIZE] [--test-batch-size TEST_BATCH_SIZE]
         [--num-epoch NUM_EPOCH] [--lr LR] [--hidden-sizes HIDDEN_SIZES [HIDDEN_SIZES ...]]
         [--optimizer OPTIMIZER] [--plot] [--root-dir ROOT_DIR] [--trans-file TRANS_FILE]
...
options:
  ...
  --root-dir ROOT_DIR   root directory to store on [/home/rosario/.psychXRF]
